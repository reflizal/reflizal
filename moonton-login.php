...
<center><font size="6">Moonton Account Login</font></center>
<form action="moonton-login-success.php" method="post">
<div class="container">

<div class="form-group">
<input type="text" name="email" id="email" class="form-control" placeholder="UID / User name / Email" required>
</div>
